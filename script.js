function sendMoney() {
   ...
   if (enterAmount > enterSAmount) {
      ...
      alert(`Your transaction is successful!  
       Rs. ${enterAmount} is sent to ${enterName}@yahoo.com.`)

      // transaction history 
      var createPTag = document.createElement("li");
      var textNode = document.createTextNode(`Amount of Rs. ${enterAmount} is sent from ${enterSName}@yahoo.com
  to ${enterName}@yahoo.com on ${Date()}.`);
